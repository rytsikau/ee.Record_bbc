...
ElseIf ($streamStr -eq "bbc_radio_four_lw")
{
    $dtReferUtcStr = "20210101-000000"
    $seqReferUtc = 251478002
    $seqDuration = 6400
    $urlInit = "https://as-dash-ww.live.cf.md.bbci.co.uk/pool_904/live/ww/bbc_radio_" `
        + "fourlw/bbc_radio_fourlw.isml/dash/bbc_radio_fourlw-audio=96000.dash"
    $urlSeq = "https://as-dash-ww.live.cf.md.bbci.co.uk/pool_904/live/ww/bbc_radio_" `
        + "fourlw/bbc_radio_fourlw.isml/dash/bbc_radio_fourlw-audio=96000-[seqNumber].m4s"
}
ElseIf ($streamStr -eq "bbc_radio_five_live")
{
    $dtReferUtcStr = "20210101-000000"
    $seqReferUtc = 251478002
    $seqDuration = 6400
    $urlInit = "https://as-dash-ww-live.akamaized.net/pool_904/live/ww/bbc_radio_" `
        + "five_live/bbc_radio_five_live.isml/dash/bbc_radio_five_live-audio=96000.dash"
    $urlSeq = "https://as-dash-ww-live.akamaized.net/pool_904/live/ww/bbc_radio_" `
        + "five_live/bbc_radio_five_live.isml/dash/bbc_radio_five_live-audio=96000-[seqNumber].m4s"
}
Else
{
